...
class GroundingDINO(nn.Module):
    ...
    def __init__(
        ...
        self.load_text_embeddings = load_text_embeddings

        if not self.load_text_embeddings:
            # bert
    ...
    def forward(self, samples: NestedTensor,
                encoded_text: Optional[torch.Tensor] = None,
        ...
        """
        # if targets is None:
        #     if kw.get("captions") is not None:
        #         captions = kw["captions"]
        # else:
        #     captions = [t["caption"] for t in targets]
        # if isinstance(captions, torch.Tensor):
        #     cache_path = get_text_dict_cache_path(captions)
        #     captions = str(captions.tolist()[0][0])
        # elif isinstance(captions, str):
        #     cache_path = get_text_dict_cache_path(captions)
        # else:
        #     cache_path = get_text_dict_cache_path(captions[0])
        #
        # if self.load_text_embeddings and os.path.exists(cache_path):
        #     # text_dict = torch.load(cache_path, map_location=samples.device)
        #     if kw.get("text_embeddings") is not None:
        #         text_dict = kw["text_embeddings"]
        # else:
        #     # encoder texts
        ...
        #     # print('Text Embedding Time:', time.time() - start_time)
        #     torch.save(text_dict, cache_path)
...
def build_groundingdino(args):
    ...
    model = GroundingDINO(
        ...
        load_text_embeddings=args.load_text_embeddings,
    )
